...
class QualityActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        var latestAccelValue: String = ""
        private var dataListener: SurfActivity.DataListener? = null

        fun registerDataListener(listener: SurfActivity.DataListener) {
        ...
        // Update the latestAccelValue and notify the registered listener
        fun updateLatestAccelValue(value: String) {
            latestAccelValue = value
            ...
            when (QualityActivity.sentCommand.trim()) {
                ...
                "A" -> {
                    if(response.contains("R")) {
                        latestAccelValue = response
                        Log.i("DAMN", latestAccelValue)
                        SurfActivity.updateAccelValue(response)
                        //surfValuesRef.child("Roll").setValue(response)
                    }
                }
