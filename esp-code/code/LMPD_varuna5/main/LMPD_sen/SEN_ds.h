...
#define EXAMPLE_ONEWIRE_GPIO_PIN GPIO_NUM_4
#define EXAMPLE_ONEWIRE_MAX_DEVICES 5

static const char *TAG_DS = "ds18b20";

extern uint8_t device_num;
extern uint8_t device_rom_id[EXAMPLE_ONEWIRE_MAX_DEVICES][8];

extern onewire_bus_handle_t handle_ds;
